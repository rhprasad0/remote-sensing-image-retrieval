...
queue_size=$(aws sqs get-queue-attributes --queue-url $SQS_URL --attribute-names ApproximateNumberOfMessages | jq -r .Attributes.ApproximateNumberOfMessages)
...
do
    ...
    if [[ $cloud_coverage_integer -gt 5 ]] || [[ $snow_coverage_integer -gt 5 ]]; then
    ...
    for row in {1..5}; do
        for col in {1..5}; do       
            ...
            # Create RBG PNG
            B04_png_min=$(gdalinfo -mm -json $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B04.tif | jq -r .bands[0].computedMin)
            B04_png_max=$(gdalinfo -mm -json $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B04.tif | jq -r .bands[0].computedMax)
            B03_png_min=$(gdalinfo -mm -json $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B03.tif | jq -r .bands[0].computedMin)
            B03_png_max=$(gdalinfo -mm -json $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B03.tif | jq -r .bands[0].computedMax)
            B02_png_min=$(gdalinfo -mm -json $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B02.tif | jq -r .bands[0].computedMin)
            B02_png_max=$(gdalinfo -mm -json $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B02.tif | jq -r .bands[0].computedMax)

            gdal_translate -scale $B04_png_min $B04_png_max 0 65535 $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B04.tif $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B04_scaled.tif
            gdal_translate -scale $B03_png_min $B03_png_max 0 65535 $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B03.tif $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B03_scaled.tif
            gdal_translate -scale $B02_png_min $B02_png_max 0 65535 $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B02.tif $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B02_scaled.tif

            gdal_merge.py -separate $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B04_scaled.tif \
                $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B03_scaled.tif \
                $TIF_PATH/${tile}_${row}_${col}/${tile}_${row}_${col}_B02_scaled.tif \
